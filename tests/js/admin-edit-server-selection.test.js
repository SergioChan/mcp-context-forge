...
describe("ensureAddStoreListeners", () => {
  ...
  test("tracks resources and prompts checkboxes independently", () => {
    ...
    expect(getEditSelections("associatedResources").has("res-1")).toBe(
      true
    );
    expect(getEditSelections("associatedPrompts").has("prompt-1")).toBe(
      true
    );
...
describe("ensureEditStoreListeners", () => {
  ...
  test("tracks edit-server resources and prompts independently", () => {
    ...
    expect(getEditSelections("edit-server-resources").has("res-e1")).toBe(
      true
    );
    ...
    // Cross-container isolation
    expect(getEditSelections("edit-server-tools").has("res-e1")).toBe(
      false
    );
  });
